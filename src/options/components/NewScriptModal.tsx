...
import { Zap, Plus, Trash2, ArrowUp, ArrowDown, Clock, Minus, MessageSquare, Mic, Image, Video, AlertTriangle, ChevronDown } from 'lucide-react';
          ...
          <div className="space-y-3">
            ...
            {formData.steps.length === 0 && messages.length > 0 && (
              <div className="p-8 border-2 border-dashed border-[var(--border-color)] rounded-lg text-center">
                <MessageSquare size={48} className="mx-auto mb-3 text-[var(--text-tertiary)]" />
                              ...
                              {messages.map((msg) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-3 py-2.5 text-left hover:bg-[var(--bg-tertiary)] transition-colors ${step.messageId === msg.id ? 'bg-[var(--accent-pink)]/10 border-l-2 border-[var(--accent-pink)]' : ''
                                      }`}
                                  >
                                    <div className="text-muted-foreground flex-shrink-0">
